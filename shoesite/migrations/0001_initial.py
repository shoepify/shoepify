# Generated by Django 4.2.16 on 2024-12-23 17:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Processing', 'Processing'), ('In-Transit', 'In-Transit'), ('Delivered', 'Delivered'), ('Cancelled', 'Cancelled')], default='NULL', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='products', to='shoesite.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='shoesite.orderitem')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shoesite.product'),
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
